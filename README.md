...
Главный экран показывает pilot claims notice: приложение предназначено для сравнения с
эталонным урофлоуметром, не ставит диагноз и не рекомендует лечение.
